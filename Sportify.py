...
if generate_btn and sport:
    if not OPENROUTER_API_KEY or OPENROUTER_API_KEY == "your_api_key_here":
        ...
        with st.spinner(f"🧠 Designing your {days}-day plan..."):
            ...
            Requirements:
            1. Create a training play for {days}-days for {sport}. You can group days that have the sames schedule (try to do that more often)
            2. Include rest days as needed (approximately every 3-5 days)
            3. For every day, specify:
