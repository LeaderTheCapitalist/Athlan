...
# App UI - Clean version without API key help
st.set_page_config(page_title="Sportify AI - Your AI Fitnes Coach", layout="wide")
st.title("Sportify")
st.caption(f"Create your personalized training plan")
...
if generate_btn and sport:
    if not OPENROUTER_API_KEY or OPENROUTER_API_KEY == "your_api_key_here":
        ...
        with st.spinner("🧠 Designing your custom training plan..."):
            ...
            -Equipment availibility: {equipment if equipment else "None"}
